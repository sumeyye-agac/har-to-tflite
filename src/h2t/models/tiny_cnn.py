...
def build_tiny_cnn(input_shape: tuple[int, ...], num_classes: int, learning_rate: float = 1e-3) -> Any:
    try:
    ...
    model = tf.keras.Sequential(
        [
            ...
            tf.keras.layers.Conv1D(24, kernel_size=3, padding="same", activation="relu"),
